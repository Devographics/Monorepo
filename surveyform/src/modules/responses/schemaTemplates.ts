...
export const templates: {
  ...
  slider: ({ allowother = false }) => ({
    ...
    afterInput: 'bar',
    options: [
      { value: 0, intlId: "options.slider.0" },
      { value: 1, intlId: "options.slider.1" },
      { value: 2, intlId: "options.slider.2" },
      { value: 3, intlId: "options.slider.3" },
      { value: 4, intlId: "options.slider.4" },
      { value: 5, intlId: "options.slider.5" },
      { value: 6, intlId: "options.slider.6" },
    ],
  }),
