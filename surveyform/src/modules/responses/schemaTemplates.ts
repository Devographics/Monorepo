...
export const templates: {
  ...
  slider: ({ allowother = false }) => ({
    ...
    suffix: "choices",
    options: [
      { value: 0, intlId: "options.range.0" },
      { value: 1, intlId: "options.range.1" },
      { value: 2, intlId: "options.range.2" },
      { value: 3, intlId: "options.range.3" },
      { value: 4, intlId: "options.range.4" },
      { value: 5, intlId: "options.range.5" },
      { value: 6, intlId: "options.range.6" },
    ],
  }),
