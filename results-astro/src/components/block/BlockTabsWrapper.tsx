...
import BlockSwitcher from '@/components/ui/DummyReact'
import * as Tabs from '@radix-ui/react-tabs'
import BlockTitle from '@/components/ui/DummyReact'
import styled, { css } from 'styled-components'
import { mq, spacing, fontSize } from '@/lib/theme'
// import { getBlockTabTitle } from 'core/helpers/blockHelpers'
const getBlockTabTitle = (...args: any[]) => "TODO getBlockTabTitle"
// import { usePageContext } from 'core/helpers/pageContext'
// import { useEntities } from 'core/helpers/entities'
import BlockTakeaway from '@/components/ui/DummyReact'
// import { useI18n } from '@devographics/react-i18n'
const getString = (...args: any[]) => "TODO getString"
// import  { CustomVariant, useCustomVariants } from 'core/filters/helpers'
type CustomVariant = any
import T from '@/components/ui/DummyReact'
import CustomVariantWrapper from '@/components/ui/DummyReact'
import ModalTrigger from '@/components/ui/DummyReact'

import Button from '@/components/ui/DummyReact'
import FiltersPanel from '@/components/ui/DummyReact'
import EditIcon from '@/components/ui/DummyReact'
import BlockQuestion from '@/components/ui/DummyReact'
...
export const TabsWrapper = ({
    ...
    const entities: Array<any> = []// useEntities()
    ...
    const blockCustomVariants = customVariants.filter((v: any) => v.blockId === block.id)
                    ...
                    <BlockHeaderRight_>
                        {showTabs && (
                            <TabsList aria-label="tabs example">
                                {block.variants.map((block: any, variantIndex: any) => (
                                    <Tab_ key={block.id}>
...
const Wrapper = styled.section<{ withMargin: boolean }>`
    ${props =>
        props.withMargin &&
        css`
