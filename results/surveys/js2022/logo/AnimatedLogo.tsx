        ...
        >
            <defs>
                ...
                <radialGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                >
                    <stop offset="0" stopColor="#55a3a9" />
                    <stop offset="1" stopColor="#56D498" />
                </radialGradient>
                <radialGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                >
                    <stop offset="0" stopColor="#075a59" />
                    <stop offset=".001" stopColor="#2d748c" stopOpacity=".997" />
                    <stop offset=".096" stopColor="#2f98a0" stopOpacity=".796" />
                    <stop offset=".188" stopColor="#41adb5" stopOpacity=".629" />
                    <stop offset=".277" stopColor="#55a3a9" stopOpacity=".499" />
                    <stop offset=".36" stopColor="#4dbba7" stopOpacity=".406" />
                    <stop offset=".437" stopColor="#56D498" stopOpacity=".349" />
                    <stop offset=".5" stopColor="#56D498" stopOpacity=".33" />
                    <stop offset="1" stopColor="#8ef9c5" stopOpacity="0" />
                </radialGradient>
                <radialGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                >
                    <stop offset="0" stopColor="#55BFC6" />
                    <stop offset=".5" stopColor="#56D498" stopOpacity=".33" />
                    <stop offset="1" stopColor="#70dba7" stopOpacity="0" />
                </radialGradient>
                <radialGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                >
                    <stop offset="0" stopColor="#52f2ca" />
                    <stop offset=".5" stopColor="#31b3a8" stopOpacity=".33" />
                    <stop offset="1" stopColor="#1a857a" stopOpacity="0" />
                </radialGradient>
            </defs>
            ...
            <g data-name="Text">
                ...
                <g className="soj-text soj-text--year" data-name="Y2021">
                    ...
                    />
                    <path
                        d="M 1602.5362 286.3766 c -2.5205 0 -4.1045 1.3682 -4.1045 4.9683 v 5.4004 h -7.4883 v -4.896 c 0 -8.0649 4.0322 -12.6733 11.8086 -12.6733 s 11.8096 4.6084 11.8096 12.6733 c 0 15.8413 -15.7695 21.7456 -15.7695 30.0264 a 5.5035 5.5035 0 0 0 0.0713 1.0801 h 14.9775 v 7.2007 h -22.8975 V 323.964 c 0 -14.8335 15.6973 -17.2817 15.6973 -31.8271 C 1606.6407 287.6007 1605.0567 286.3766 1602.5362 286.3766 Z"
                        style={{ '--char': 1 } as React.CSSProperties}
                    />
                </g>
            </g>
