...
import { VerticalBox, VerticalBoxProps } from './VerticalBox'
import { StandardQuestionData } from '@devographics/types'
import { useTheme } from 'styled-components'
import { useChartLabelFormatter } from '../../../src/core/charts/hooks'
...
export const getChartData = (data: StandardQuestionData) =>
    sortBy(data?.responses?.currentEdition.buckets, b => b.percentilesByFacet?.p50)

export const VerticalBoxPlotChart = ({
    legends,
    series,
    containerWidth = 500,
    height = 300,
...
export default VerticalBoxPlotChart
