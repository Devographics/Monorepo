...
addPastParticipations.description = `Add past edition counts (how many times someone has taken other surveys before) where missing.`;

addPastParticipations.category = "migrations";
