...
const NonMemoizedNode = ({
    ...
    const { metric, setCurrentTool } = useToolsQuadrantsChartContext()
        ...
        >
            ...
            <LabelGroup
                ...
                transform={to(
                    ...
                    (labelOffset: number) =>
                        `translate(${12 + translateLabel[0] + labelOffset},${
                            1 + translateLabel[1]
                        })`
                )}
            >
                ...
                />
                <LabelText $isHover={isHover} alignmentBaseline="middle" fill={theme.colors.text}>
                    {name}
                </LabelText>
            </LabelGroup>
        </animated.g>
